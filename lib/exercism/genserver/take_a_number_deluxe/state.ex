defmodule Exercism.Genserver.TakeANumberDeluxe.State do
  defstruct min_number: 1, max_number: 999, queue: nil, auto_shutdown_timeout: :infinity
  @type t :: %__MODULE__{}

  alias Exercism.Genserver.TakeANumberDeluxe.Queue
  ...
  @spec queue_new_number(__MODULE__.t()) ::
          {:ok, integer(), __MODULE__.t()} | {:error, atom()}
  ...
  @spec serve_next_queued_number(__MODULE__.t(), integer() | nil) ::
          {:ok, integer(), __MODULE__.t()} | {:error, atom()}
