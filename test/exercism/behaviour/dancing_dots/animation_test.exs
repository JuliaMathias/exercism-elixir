defmodule Exercism.Behaviour.DancingDots.AnimationTest do
  use ExUnit.Case
  import ExUnit.CaptureIO

  alias Exercism.Behaviour.DancingDots
  ...
  describe "Animation module" do
    ...
    test "__using__ sets Animation as the behaviour, emitting compilation warnings about missing callbacks" do
      ...
      assert compilation_warnings =~
               "\e[33mwarning: \e[0mfunction handle_frame/3 required by behaviour Exercism.Behaviour.DancingDots.Animation is not implemented (in module TestAnimation5)\n  nofile: TestAnimation5 (module)\n\n"
    end
  end
